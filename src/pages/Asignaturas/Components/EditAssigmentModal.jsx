...
const EditAssigmentModal = ({
  ...
  const [nombre, setNombre] = useState(asignaturaedit.nombre);
  const [siglas, setSiglas] = useState(asignaturaedit.siglas);
  const [coulor, setcoulor] = useState(asignaturaedit.color);
  ...
  const update = async (e) => {
    ...
    await axios.put(`${endpoint}/${asignaturaedit.id} `, {
      nombre: nombre,
      siglas: siglas,
      color: coulor,
    });
