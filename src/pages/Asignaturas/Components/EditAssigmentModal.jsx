...
const EditAssigmentModal = ({
  ...
  const [nombre, setNombre] = useState(selectedAsignatura.nombre);
  const [siglas, setSiglas] = useState(selectedAsignatura.siglas);
  const [coulor, setcoulor] = useState(selectedAsignatura.color);
  ...
  const update = async (e) => {
    ...
    await axios.put(`${apiURL}/asignaturas/${selectedAsignatura.id} `, {
      nombre: nombre,
      siglas: siglas,
      color: coulor,
    });
                  ...
                  <div>
                    <div className="flex w-80 flex-wrap md:flex-nowrap mb-6 md:mb-0 gap-4">
                      <Input
                        ...
                        label="Siglas"
                        defaultValue={siglas}
                        placeholder="Enter the Assigment siglas"
                      />
                    </div>
                  </div>
